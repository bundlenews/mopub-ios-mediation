...
s.source           = { :git => 'https://github.com/mopub/mopub-ios-mediation.git', branch: 'bundle-patches', :commit => '701d982059d236fbc411d22d91cbe27dcddf6519' }
s.ios.deployment_target = '8.0'
s.static_framework = true
s.source_files = 'AdMob/*.{h,m}'
s.dependency 'mopub-ios-sdk', '~> 5.0'
s.dependency 'Google-Mobile-Ads-SDK', '7.34.0'
end
